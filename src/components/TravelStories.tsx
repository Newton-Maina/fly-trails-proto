      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
          ...
          <div className="relative group cursor-pointer reveal-zoom">
            ...
            <div className="absolute -bottom-12 -left-4 bg-white p-8 md:p-12 shadow-2xl rounded-sm border-l-[8px] border-[#3c4a3e] max-w-[95%]">
              ...
              <a href="#" className="flex items-center gap-4 text-[#3c4a3e] font-black text-[13px] uppercase tracking-widest hover:underline group/link">
                 <span className="w-6 h-6 rounded-full border-[2.5px] border-[#3c4a3e] flex items-center justify-center text-[11px] leading-none transition-transform group-hover/link:translate-x-1">➔</span>
                 Read Story
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-14 lg:pt-0 pt-32 reveal-up" style={{ transitionDelay: '300ms' }}>
            {sideStories.map((story, i) => (
              <div key={i} className="border-t-[1.5px] border-slate-200 pt-10 group cursor-pointer first:border-t-0 first:pt-0">
                <span className="inline-block bg-[#3c4a3e] text-white text-[10px] font-black px-4 py-1.5 rounded-sm uppercase tracking-[0.2em] mb-5 shadow-sm">
                  {story.author}
                </span>
                ...
                <a href="#" className="flex items-center gap-4 text-[#3c4a3e] font-black text-[13px] uppercase tracking-widest group/link">
                   <span className="w-6 h-6 rounded-full border-[2.5px] border-[#3c4a3e] flex items-center justify-center text-[11px] leading-none transition-transform group-hover/link:translate-x-1">➔</span>
                   Read more
                </a>
              </div>
